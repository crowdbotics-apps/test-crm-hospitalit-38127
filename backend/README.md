...
## Project Structure
    ...
    ├── test_crm_hospitalit_38127  # Django project configurations
...
1. Clone this repo and `cd test_crm_hospitalit_38127`
...
2. Clone this repo and `cd test_crm_hospitalit_38127`
